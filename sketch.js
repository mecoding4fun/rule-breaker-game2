...
function preload(){
  ...
  culprit_left_img_1 = loadAnimation("man-2.png","man-3.png","man-4.png","man-5.png");
  background_img = loadImage("bg-img.jpg");
  police_img = loadAnimation("police-1.png","police-6.png","police-7.png");
  police_left = loadAnimation("policeright1.png","policeright2.png","policeright3.png");
...
ohnoSound = loadSound('oh no.mp3');
  ...
  culprit_right = loadAnimation("right1.png","right2.png","right3.png","right4.png");
...
function setup() {
  ...
  police.addAnimation("policeright",police_left);
  police.scale = 0.8;
  police.velocityX = 3;
  police.velocityY = -1;
...
border_right = createSprite(width-210,height/4-50,3,250);
  ...
  culprit_1.addAnimation("culprit",culprit_left_img_1);
  culprit_1.addAnimation("right",culprit_right);
...
//     text("Fine collected: "+ score, 500,50);
     ...
     if(keyDown(LEFT_ARROW)){
        police.changeAnimation("policeright",police_left);      
  police.velocityX= -6;
  police.velocityY= 0;
  ...
  police.changeAnimation("policeleft",police_img);
  police.velocityX= 6;
  police.velocityY= 0;
  ...
  whistleSound.play();  
    ...
    // culprit_1.changeAnimation("turning",boy_stand);
     // culprit_1.changeAnimation("culprit",culprit_left_img_1);
    
    if(culprit_1.velocityX > 0 ){    
      culprit_1.changeAnimation("right",culprit_right);
      print("moving right");
    }
    if(culprit_1.velocityX < 0 ){    
      culprit_1.changeAnimation("culprit",culprit_left_img_1);      
